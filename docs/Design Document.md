...
- Stage 4 chunk processing runs at 3x the normal interval and uses a separate chunk-nuking queue so full nukes can be budgeted independently from normal degradation passes.
